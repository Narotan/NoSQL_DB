...
> Тесты моделируют одновременную работу нескольких клиентов и гарантируют, что ваша NoSQLdb устойчива к гонкам и конфликтам при параллельных изменениях.

**Тесты конкурентности теперь находятся в папке [`tests/`](./tests/).**
